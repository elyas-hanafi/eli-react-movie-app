...
## _The experience of making a movie website with ReactJs

tMovies is a  Responsive React Movies App With API

- Advanced React Best Practices such as folder & file structure, hooks and refs
- Creating a User Interface using Sass
...
## Features
- Responsive web
- Show movie trailers with YouTube
- ✨Search capability✨
- Moder UI design
